...
function garageActionLabel(topKey,bottomKey){return `<span class="garage-action-label"><strong>${escapeHtml(t(topKey))}</strong><small>${escapeHtml(t(bottomKey))}</small></span>`}
